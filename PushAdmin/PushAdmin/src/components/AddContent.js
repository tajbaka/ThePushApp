        ...
        return (
            <div className='container' style={{flexDirection: 'column'}}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column'}}>
                    <label style={{ color: 'white', display: 'flex'}} > Add or Remove Content </label>
                </div>
                <div style={{display: 'flex', flexDirection: 'column'}}>
                    {levelData.map((level, levelIndex) => 
                        <div key={levelIndex}>
                            {level == null ? 
                                !this.state.addLevel ?
                                <div onClick={this.addContentClicked.bind(this, 'addLevel')} style={{display: 'flex', marginTop: 80, borderRadius: 5, backgroundColor: '#2AA198', padding: 30, justifyContent:'center'}}>
                                    <label style={{color: 'white', fontSize: 40}}>
                                        +
                                    </label>
                                </div> 
                                :
                                <div style={{display: 'flex', flexDirection: 'row', marginTop: 80, borderRadius: 5,  backgroundColor: '#2AA198', padding: 30, justifyContent:'space-between'}}>
                            ...
                            { this.state['levelClicked' + levelIndex] ?
                                toolData.map((tool, toolIndex) =>
                                    <div key={'tool' + toolIndex}>
                                        {tool == null ? 
                                            !this.state.addTool ? 
                                            <div onClick={this.addContentClicked.bind(this, 'addTool')} style={{display: 'flex', borderRadius: 5,  backgroundColor: '#B58900', padding: 30, justifyContent:'center', marginLeft: '5%', marginTop: 50}}>
                                                <label style={{color: 'white', fontSize: 40}}>
                                                    +
                                                </label>
                                            </div> 
                                            :
                                            <div style={{display: 'flex', flexDirection: 'row', borderRadius: 5,  backgroundColor: '#B58900', padding: 30, justifyContent:'space-between', marginLeft: '5%', marginTop: 50}}>
                                                <div style={{ color: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                                                    <label>
                                                        Tool Name
                                                    </label>
                                        ...
                                        :
                                        <div onClick={this.expand.bind(this, toolIndex, 'tool')}  style={{display: 'flex', flexDirection: 'row', borderRadius: 5,  backgroundColor: '#B58900', padding: 30, justifyContent:'space-between', marginLeft: '5%', marginTop: 50}}>
                                            <div style={{ color: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                                                <label>
                                                    Tool Name
                                                </label>
                                                <label style={{minHeight: '10%', minWidth: '80%'}} id={'level' + levelIndex + 'toolname' + toolIndex} contentEditable='true'>
                                                    ...
                                                    {   
                                                        ...
                                                        <div style={{textAlign: 'center', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center'}}>
                                                            ...
                                                            <button id={'level' + levelIndex + "toolrecordingbutton" + toolIndex + recordingKey} onClick={this.deleteRecording.bind(this, 'tool', 'recording', recordingKey, levelIndex, toolIndex)} style={{marginLeft: 20}}> Remove </button>
                                                        </div>
                                                        }
                                                        </div>
                                                    </div>
                                            ...
                                            practiceData.map((practice, practiceIndex) =>
                                                <div key={'practice' + practiceIndex}> 
                                                    ...
                                                    {practice == null ? 
                                                        ...
                                                        <div onClick={this.addContentClicked.bind(this, 'addPractice')} style={{display: 'flex', borderRadius: 5,  backgroundColor: '#268BD2', padding: 30, justifyContent:'center', marginLeft: '10%', marginTop: 50}}>
                                                            <label style={{color: 'white', fontSize: 40}}>
                                                                +
                                                            </label>
                                                        </div> 
                                                        : 
                                                        <div style={{display: 'flex', flexDirection: 'row', borderRadius: 5,  backgroundColor: '#268BD2', padding: 30, justifyContent:'space-between', marginLeft: '10%', marginTop: 50}}>
                                                            <div style={{ color: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                                                                <label>
                                                                    Practice Name
                                                                </label>
